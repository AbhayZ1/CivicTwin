...
topologies for \CGCEN{}, giving $240$ model instances of which $200$ are
trained ($40$ persistence instances are parameter-free). Aggregate statistics use
...
\input{paper_assets/tables/table_benchmark_results.tex}
...
\input{paper_assets/tables/table_policy_scorecard.tex}
